...
}information[n] = { { 1012 , 1.85, 64.3 ,"王玉升", "男", {2003, 10, 12}, {2003, 10, 12}, {123, 123, 123, 123, 123}},  { 1013 , 1.85, 64.3 ,"6", "男", {2003, 10, 12}, {2003, 10, 12}} };
...
void gradeInput(){
    ...
    while( y ){
        ...
        printf("\n\n\n\n\t\t\t\t当前系统内有%d位学生的成绩!\n", Gstu);
        Sleep(1000);
        information[a].grade.sum = information[a].grade.Chinese + information[a].grade.Clanguage + information[a].grade.English + information[a].grade.Maths + information[a].grade.PE; 
        system("cls");
        printf("\n\n\n\n\t\t\t\t是否继续输入?   Y/N");
        Sleep(300);
        char temp1 = 'a';
...
void informationSearch(){
    ...
    if ( temp4 == '3'){
        ...
        if ( j == '6'){
            ...
            int i = 0;
            while ( information[i].stuID ){
                if ( information[i].grade.sum == arr){
                    printf("%s\t%-5d\t%s\t\t%.2f    %.2f\t\t%4d/%2d/%2d\t%4d/%2d/%2d\n", information[i].name, information[i].stuID, information[i].sex, information[i].stuheight, information[i].stuweight, information[i].birthday.year, information[i].birthday.month, information[i].birthday.day, information[i].regday.year, information[i].regday.month, information[i].regday.day);
                }
                i++;
            }
...
void gradeSearch(){
    ...
    if ( temp5 == '2'){
        ...
        while ( information[i].stuID ){
            if ( information[i].stuID == arr ){
                temp4 = 1;
                printf("\n\n\n\n姓名\t语文\t数学\t英语\t体育\tC语言\t总成绩\n");
                if (information[i].grade.Chinese == 0 && information[i].grade.Clanguage == 0 && information[i].grade.English == 0 && information[i].grade.Maths == 0 && information[i].grade.PE == 0){
                    printf("%s的成绩未录入!\n", information[i].name);
                    break;
                }
                else {
                    printf("%s\t%d\t%d\t%d\t%d\t%d\t%d\n", information[i].name, information[i].grade.Chinese, information[i].grade.Maths, information[i].grade.English, information[i].grade.PE, information[i].grade.Clanguage, information[i].grade.sum);
                    break;
                }
            }
            i++;
